    ...
    <div className="w-full max-w-[900px] flex rounded-2xl overflow-hidden border border-border shadow-2xl glass min-h-[500px]">
      ...
      <div className="hidden md:flex md:w-1/2 bg-muted p-10 flex-col justify-between relative overflow-hidden">
        ...
        <div className="relative z-10 space-y-4">
          <h2 className="text-3xl font-bold">Start gathering insights today.</h2>
          <p className="text-muted-foreground">
            Join thousands of teams using PollForm to make data-driven decisions.
          </p>
        </div>
      </div>
      ...
      <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center bg-card">
        <div className="max-w-sm w-full mx-auto space-y-8">
          ...
          <p className="text-center text-sm text-muted-foreground pt-4">
            ...
            <Link to="#" className="underline underline-offset-4 hover:text-primary">Terms of Service</Link> and <Link to="#" className="underline underline-offset-4 hover:text-primary">Privacy Policy</Link>.
          </p>
        </div>
      </div>
    </div>
